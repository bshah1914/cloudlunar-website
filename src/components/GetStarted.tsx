...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 transition-colors text-gray-500 hover:text-gray-400"
  ...
  return (
    <section id="get-started" className="relative py-28 md:py-36 bg-grid">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <span className="text-emerald-600 text-sm font-semibold tracking-widest uppercase">Get Started</span>
            ...
            {platforms.map((p) => (
              <button
                ...
                className={`flex items-center gap-3 px-5 py-3.5 rounded-xl text-left transition-all flex-1 ${
                  activePlatform === p.id
                    ? "bg-blue-500/15 border border-blue-500/30 text-gray-900 dark:text-white"
                    : "bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 text-gray-500 hover:bg-gray-100 dark:hover:bg-white/10 hover:text-gray-400"
                }`}
              >
                <p.icon className={`w-5 h-5 flex-shrink-0 ${activePlatform === p.id ? "text-blue-400" : "text-gray-500 dark:text-gray-400"}`} />
                <div>
          ...
          {activePlatform === "docker" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Docker Compose Setup</h3>
              ...
              <div className="space-y-3">
                {dockerSteps.map((step, i) => (
                  <div key={i} className="bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5 overflow-hidden">
                    <div className="flex items-center justify-between px-4 py-2 border-b border-gray-100 dark:border-white/5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[11px] text-gray-500 dark:text-gray-400">{step.label}</span>
                      </div>
                      <CopyButton text={step.cmd} />
                    </div>
                    <div className="px-4 py-3">
                      <code className="text-sm text-green-700 dark:text-green-400 font-mono">$ {step.cmd}</code>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 p-4 bg-blue-500/5 rounded-xl border border-blue-500/10">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  <span className="text-blue-600 dark:text-blue-400 font-semibold">Tip:</span> After running <code className="text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-500/10 px-1.5 py-0.5 rounded text-[11px]">docker-compose up -d</code>, open{" "}
          ...
          {activePlatform === "manual" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Manual Installation</h3>
              </div>

              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 dark:bg-white/5 rounded-xl p-4 border border-gray-100 dark:border-white/5">
                  <h4 className="text-xs font-semibold text-gray-400 dark:text-gray-500 mb-2">Prerequisites</h4>
                ...
                <div className="bg-gray-50 dark:bg-white/5 rounded-xl p-4 border border-gray-100 dark:border-white/5">
                  <h4 className="text-xs font-semibold text-gray-400 dark:text-gray-500 mb-2">Supported Platforms</h4>
                  <ul className="space-y-1.5 text-xs text-gray-500 dark:text-gray-400">
                    <li className="flex items-center gap-2"><Monitor className="w-3 h-3 text-blue-400" /> Linux (Ubuntu, Debian, CentOS)</li>
                    <li className="flex items-center gap-2"><Apple className="w-3 h-3 text-gray-500" /> macOS (Intel & Apple Silicon)</li>
              ...
              <div className="space-y-3">
                {manualSteps.map((step, i) => (
                  <div key={i} className="bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5 overflow-hidden">
                    ...
                    <div className="px-4 py-3">
                      <pre className="text-sm text-green-700 dark:text-green-400 font-mono whitespace-pre-wrap">$ {step.cmd}</pre>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {activePlatform === "mobile" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Install as Mobile App (PWA)</h3>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">
                CloudLunar is a <strong className="text-gray-900 dark:text-white">Progressive Web App</strong> — install it directly from your browser to your home screen. No App Store or Play Store needed. Same app, instant updates, works on any device.
              </p>

              {/* Install Instructions */}
              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                {/* iOS */}
                <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-200 dark:border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all group">
                  ...
                  <h4 className="text-base font-bold text-gray-900 dark:text-white mb-1 text-center">iPhone & iPad</h4>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-4 text-center">Safari browser</p>
                  <ol className="space-y-2.5 text-xs text-gray-500 dark:text-gray-400">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Open <strong className="text-gray-900 dark:text-white">CloudLunar dashboard</strong> in Safari</span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>Tap the <strong className="text-gray-900 dark:text-white">Share</strong> button (square with arrow)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>Select <strong className="text-gray-900 dark:text-white">"Add to Home Screen"</strong></span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>Tap <strong className="text-gray-900 dark:text-white">"Add"</strong> — done! Opens fullscreen like a native app</span>
                    </li>
                  </ol>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-200 dark:border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all group">
                  ...
                  <h4 className="text-base font-bold text-gray-900 dark:text-white mb-1 text-center">Android & Desktop</h4>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-4 text-center">Chrome / Edge browser</p>
                  <ol className="space-y-2.5 text-xs text-gray-500 dark:text-gray-400">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Open <strong className="text-gray-900 dark:text-white">CloudLunar dashboard</strong> in Chrome</span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>Tap the <strong className="text-gray-900 dark:text-white">"Install"</strong> prompt in the address bar</span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>Or tap <strong className="text-gray-900 dark:text-white">⋮ → "Install app"</strong> from the menu</span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>Confirm <strong className="text-gray-900 dark:text-white">"Install"</strong> — app icon appears on home screen</span>
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
                {[
                  ...
                  <div key={feature.label} className="bg-gray-50 dark:bg-white/5 rounded-xl p-4 border border-gray-100 dark:border-white/5">
                    <div className="flex items-center gap-2.5 mb-2">
                      <feature.icon className={`w-4 h-4 ${feature.color}`} />
                      <h4 className="text-xs font-semibold text-gray-900 dark:text-white">{feature.label}</h4>
                    </div>
                    <p className="text-[11px] text-gray-500 dark:text-gray-400">{feature.desc}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-600/10 to-cyan-600/10 border border-blue-500/15 rounded-xl p-6">
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  <div className="flex gap-3 flex-shrink-0">
                    {/* Phone Mockup */}
                    <div className="w-28 h-48 rounded-2xl bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-white/10 p-2 shadow-xl">
                      <div className="w-full h-full rounded-xl bg-gradient-to-b from-blue-100 to-cyan-50 flex flex-col items-center justify-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-blue-500/30 flex items-center justify-center">
                          <BarChart3 className="w-4 h-4 text-blue-400" />
                        </div>
                        <div className="w-14 h-1.5 rounded bg-gray-200" />
                        <div className="w-10 h-1 rounded bg-gray-100" />
                        ...
                        <div className="w-16 h-2 rounded bg-gray-100 mt-1" />
                        <div className="w-16 h-2 rounded bg-gray-100" />
                        <div className="w-16 h-2 rounded bg-gray-100" />
                      </div>
                    </div>
                    {/* Desktop Mockup */}
                    <div className="w-36 h-48 rounded-xl bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-white/10 p-2 shadow-xl hidden sm:block">
                      <div className="w-full h-3 rounded-t-lg bg-gray-300 flex items-center px-1.5 gap-1 mb-1">
                        <div className="w-1.5 h-1.5 rounded-full bg-red-500/50" />
                        <div className="w-1.5 h-1.5 rounded-full bg-amber-500/50" />
                        <div className="w-1.5 h-1.5 rounded-full bg-green-500/50" />
                      </div>
                      <div className="w-full h-[calc(100%-16px)] rounded-b-lg bg-gradient-to-b from-blue-50 to-cyan-50 flex flex-col items-center justify-center gap-1.5">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-2">Why a PWA Instead of Native Apps?</h4>
              ...
              <div className="mt-6 text-center">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-gray-900 font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-cyan-500/25 hover:-translate-y-0.5"
                >
                  Open Dashboard to Install <ExternalLink className="w-4 h-4" />
                </a>
                <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-2">Open in Chrome or Safari, then follow the steps above</p>
              </div>
            </motion.div>
          )}
          ...
          {activePlatform === "cloud" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Hosted Dashboard</h3>
              </div>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div className="bg-gradient-to-br from-blue-600/10 to-cyan-600/10 border border-blue-500/20 rounded-xl p-6 text-center">
                  ...
                  <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-2">Web Dashboard</h4>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">Full-featured dashboard accessible from any browser. Connect your AWS account and start scanning immediately.</p>
                  <a
                    href={TOOL_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-gray-900 text-sm font-medium rounded-xl transition-all hover:shadow-lg hover:shadow-blue-500/25"
                  >
                    Open Dashboard <ExternalLink className="w-4 h-4" />
                  </a>
                </div>

                <div className="bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 rounded-xl p-6">
                  <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-3">What's Included</h4>
        ...
        >
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-gray-500/10 flex items-center justify-center flex-shrink-0">
              <GitBranch className="w-6 h-6 text-gray-500 group-hover:text-gray-900 dark:group-hover:text-white transition-colors" />
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-blue-300 transition-colors">Source Code</p>
              <p className="text-[11px] text-gray-500 dark:text-gray-400">View on GitHub</p>
            </div>
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-green-300 transition-colors">Download Release</p>
              <p className="text-[11px] text-gray-500 dark:text-gray-400">Latest stable version</p>
            </div>
            <ExternalLink className="w-4 h-4 text-gray-400 dark:text-gray-500 ml-auto" />
          </a>
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-amber-300 transition-colors">Documentation</p>
              <p className="text-[11px] text-gray-500 dark:text-gray-400">Setup guide & API docs</p>
            </div>
            <ExternalLink className="w-4 h-4 text-gray-400 dark:text-gray-500 ml-auto" />
          </a>
        </motion.div>
