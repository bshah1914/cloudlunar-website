      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-gray-300 font-medium">AI-Driven Optimization</span>
          </motion.div>
        ...
        <div className="relative mb-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, i) => (
              ...
              >
                {/* Step number */}
                <div className="absolute -top-3 -left-2 w-7 h-7 rounded-full bg-[#0a1628] border border-blue-500/20 flex items-center justify-center z-10">
                  <span className="text-[10px] font-bold text-blue-400">{String(i + 1).padStart(2, "0")}</span>
                </div>

                <div className="glass-card p-6 h-full relative overflow-hidden group-hover:border-white/[0.12] transition-all duration-500">
                  {/* Glow on hover */}
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              <h3 className="text-xl font-bold text-white mb-2">AI Engine Performance</h3>
              <p className="text-sm text-gray-400">Real numbers from real infrastructure analysis.</p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
              {metrics.map((metric, i) => (
                ...
                >
                  ...
                  <p className="text-[10px] text-gray-600">{metric.sublabel}</p>
                </motion.div>
              ))}
            </div>
          </div>
